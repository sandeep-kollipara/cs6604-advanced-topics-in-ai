...
In case of Backward Stepwise Linear Regression, you will receive a dictionary features as keys and their Adjusted R-squared metric as values ranging between 0 and 1.
Calculate the difference of Adjusted R-squared between the adjacent features, like between first and second, between second and third, and so on, like first key's value minus second key's value.
